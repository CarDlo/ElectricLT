<x-admin-layout>
    ...
    <div class="flex justify-between p-2 mb-2 text-sm text-black-800 rounded-lg bg-white dark:bg-gray-800 dark:text-blue-400" role="alert">
        <h3 class="text-3xl font-bold dark:text-white">Subcontratistas</h3>
        ...
        @include('subcontratista.dial-modal')
    </div>

    @include('subcontratista.crear-modal')

    @include('subcontratista.table')
